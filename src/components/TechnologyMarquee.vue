...
<template>
  <section class="relative z-[2] overflow-hidden border-y border-black/15 bg-[#f4f4f1] py-8 text-[#000000] sm:py-10">
    <h2 class="sr-only">Selected technologies</h2>
    <div class="technology-track flex w-max items-center motion-reduce:transform-none">
