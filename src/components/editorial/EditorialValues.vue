  ...
  <section id="experience" class="bg-[var(--ink)] px-4 py-28 text-[var(--paper)] sm:px-7 md:py-44 lg:px-12">
    <div class="mx-auto max-w-[1800px]">
      ...
      <div class="mt-32 grid gap-12 border-t border-white/25 pt-8 lg:grid-cols-12 lg:items-end">
        <figure data-image-reveal class="m-0 overflow-hidden lg:col-span-5"><img :src="profileImage" alt="Profile portrait of Izuchukwu Tony" loading="lazy" class="aspect-[4/5] h-full w-full object-cover object-[70%_center] grayscale" /></figure>
