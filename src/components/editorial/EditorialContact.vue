...
<template>
  <section id="contact" class="bg-[var(--ink)] px-4 py-28 text-[var(--paper)] sm:px-7 md:py-40 lg:px-12">
    <div class="mx-auto max-w-[1800px]">
      <header class="grid gap-8 lg:grid-cols-12"><div class="lg:col-span-5"><p class="m-0 text-xs uppercase tracking-[.1em]">Start a conversation</p><h2 class="mt-8 mb-0 text-[clamp(4rem,9vw,10rem)] leading-[.78] tracking-[-.075em] uppercase">Tell me<br />about it</h2></div><p class="m-0 max-w-md self-end text-base leading-relaxed text-white/72 lg:col-span-4 lg:col-start-8">{{ contactDetails.subtext }}</p></header>
